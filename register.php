            ...
            <div class="window bg-light text-dark card">
                <div class="card-body p-5 text-center">
                    <div class="mb-md-1 mt-md-3 pb-5">
                        ...
                        <div class="form-outline form-black mb-3">
                            <input type="password" name="password" id="pass" placeholder="Hasło" class="form-control form-control-lg"/>
                        </div>
                        <div class="form-outline form-black mb-5">
                            <input type="password" name="confirmpass" id="pass2" placeholder="Potwierdź hasło"
                                   class="form-control form-control-lg"/>
                        </div>
                    ...
                    <div class="register">
                        <p class="mb-0">Posiadasz już konto? <a href="login" class="text-black-50 fw-bold">Zaloguj
                                się</a></p>
                    </div>
                </div>
            </div>
